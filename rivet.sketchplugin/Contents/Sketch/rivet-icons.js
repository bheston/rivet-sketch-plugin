...
/******/ 	return __webpack_require__(__webpack_require__.s = "./src/rivet-icons.js");
/******/ })
/************************************************************************/
/******/ ({
...
/* harmony import */ var _common_util__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./common/util */ "./src/common/util.js");
...
var Icons = function Icons() {
  // Parts
  var icons, tints; // Symbols & Groups
  ...
  var _getAvailableIconsAndTints = function _getAvailableIconsAndTints() {
    var iconSymbols = _common_search__WEBPACK_IMPORTED_MODULE_4__["search"].findSymbolsByNameBegin('Rivet/Icon/');
    var tintSymbols = _common_search__WEBPACK_IMPORTED_MODULE_4__["search"].findSymbolsByNameBegin('Rivet/Icon-Tint/');
    var icons = [],
        tints = [];
    ...
    return {
      ...
      availableTints: tints
    };
  };

  var _generateIcons = function _generateIcons() {
    ...
    if (sel.count() == 1) {
      if (_common_sketch__WEBPACK_IMPORTED_MODULE_5__["sketch"].is(sel[0], MSSymbolInstance)) {
        ...
        if (symbolName.startsWith('Rivet/Icon-Container')) {
          iconContainer = sel[0];
          var params = _common_sketch__WEBPACK_IMPORTED_MODULE_5__["sketch"].describeOverrides(iconContainer);
          Object(_common_util__WEBPACK_IMPORTED_MODULE_6__["debugObject"])(params);
          initialData.config = params;
        }
      }

      if (iconContainer === null) {
        // Use selection for positioning
        layerForPositioning = sel[0];
      }
    }

    _iconsPanel(function (data) {
      _parseDataFromPanel(data); //_storeConfig();
  ...
  function _iconsPanel(callback, data) {
    return _common_panel__WEBPACK_IMPORTED_MODULE_3__["panel"].createPanel({
      url: _common_context__WEBPACK_IMPORTED_MODULE_0__["context"].getPluginRoot() + "/Contents/Resources/panel/icons.html",
      width: 850,
      height: 700,
      data: data,
  ...
  var _storeConfig = function _storeConfig() {//metadata.setConfigs(props, list);
  };

  var _setupIconContainer = function _setupIconContainer() {
    var size = icons.length == 2 ? '-Double' : icons.length == 3 ? '-Triple' : '';
    var symbol = _common_search__WEBPACK_IMPORTED_MODULE_4__["search"].findSymbolsByName('Rivet/Icon-Container/35x35' + size)[0];
  ...
  var _setIcons = function _setIcons() {
    var values = {};

    for (var i = 0; i < icons.length; i++) {
      var itemKey = 'Icon' + (icons.length == 1 ? '' : ' ' + (i + 1));
      var iconSymbol = _common_search__WEBPACK_IMPORTED_MODULE_4__["search"].findSymbolsByName('Rivet/Icon/' + icons[i])[0];
      var tintSymbol = _common_search__WEBPACK_IMPORTED_MODULE_4__["search"].findSymbolsByName('Rivet/Icon-Tint/' + tints[i])[0];
      values[itemKey] = {
        'symbolID': iconSymbol,
        'Tint': {
          'symbolID': tintSymbol
    ...
    _common_sketch__WEBPACK_IMPORTED_MODULE_5__["sketch"].updateOverrides(iconContainer, values);
  };

  var _positionSymbol = function _positionSymbol() {
    if (layerForPositioning != null) {
      _common_sketch__WEBPACK_IMPORTED_MODULE_5__["sketch"].moveLayerAbove(pageOrArtboard, layerForPositioning, iconContainer);
      var layerRect = _common_sketch__WEBPACK_IMPORTED_MODULE_5__["sketch"].getRect(layerForPositioning);
      var iconContainerRect = _common_sketch__WEBPACK_IMPORTED_MODULE_5__["sketch"].getRect(iconContainer);
  ...
  return {
    generateIcons: function generateIcons() {
      _generateIcons();
    }
  };
};
...
//# sourceMappingURL=rivet-icons.js.map